...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generateSEO({
    ...
    description: 'تصفح مشاريعنا المنجزة في جازان وجدة والدمام وجميع مناطق السعودية. أكثر من 500 مشروع منجز بأعلى معايير الجودة والاحترافية.',
    keywords: ['مشاريع مقاولات', 'مشاريع منجزة', 'فلل سعودية', 'مشاريع تجارية', 'معرض أعمال', 'مقاولات جازان', 'مقاولات جدة'],
    url: '/projects',
