...
export default function Header({ settings = {}, navigation = [] }: Props) {
  ...
  // معالجة رابط الشعار (يدعم URLs نسبية ومطلقة)
  ...
  return (
    <>
      ...
      <header className={`site-hdr ${scrolled ? 'site-hdr--scrolled' : ''}`}>
                  ...
                  <div className="site-mob__row">
                    ...
                    >
                      <span
                        ...
                        style={{ background: active ? '#ed8936' : 'transparent' }}
                      />
                      {item.label}
                    </Link>
                    {hasKids && (
  ...
  .site-hdr__nav-link::before {
    ...
    background: #D4AF37 !important; /* ✅ ذهبي ملكي */
    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important;
    transform: translateX(-50%) !important;
  }
  .site-hdr__nav-link:hover {
    color: #D4AF37 !important; /* ✅ ذهبي ملكي */
  ...
  .site-hdr__nav-link.is-active {
    background: linear-gradient(135deg, #D4AF37 0%, #B8960F 100%) !important; /* ✅ ذهبي */
  ...
  .site-hdr__dropdown-link:hover {
    ...
    color: #B8960F !important; /* ✅ ذهبي غامق */
  ...
  .site-hdr__dropdown-link:hover .site-hdr__dropdown-dot {
    background: #D4AF37 !important; /* ✅ ذهبي */
  ...
  .site-hdr__burger {
    ...
    border-radius: 10px !important;
    background: rgba(212, 175, 55, 0.15) !important; /* ✅ ذهبي خفيف */
    color: #D4AF37 !important;
    border: none !important;
    cursor: pointer !important;
    display: none !important;
  ...
  .site-hdr__search-go {
    ...
    background: linear-gradient(135deg, #D4AF37, #FFD700) !important; /* ✅ ذهبي */
    color: #0f172a !important;
    border: none !important;
    border-radius: 12px !important;
    font-weight: 700 !important;
  ...
  .site-mob__link.is-active {
    background: linear-gradient(135deg, #D4AF37, #B8960F) !important; /* ✅ ذهبي */
    color: #0f172a !important;
