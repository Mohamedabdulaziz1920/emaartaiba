  ...
  return (
    <>
      <div className="floating-buttons">
        {/* ═══════════════════════════════════
            💬 WhatsApp Button - مع pulse حول الأيقونة
            ═══════════════════════════════════ */}
        <div className="float-wrapper">
          {/* ✅ Pulse rings خارج الزر - يظهر حول الأيقونة */}
      ...
      <style jsx>{`
        ...
        .pulse-ring--2 {
          animation: pulse-effect 2s ease-out infinite 1s;
        }
        ...
        .float-tooltip {
          ...
          font-weight: 600;
          white-space: nowrap;
          animation: fade-in-right 0.2s ease;
          pointer-events: none;
          z-index: 10;
        ...
        @media (max-width: 640px) {
          ...
          /* Reduce pulse on mobile for less distraction */
          .pulse-ring--2 {
            display: none;
          }
        }
